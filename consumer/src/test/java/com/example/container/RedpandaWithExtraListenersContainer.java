...
public class RedpandaWithExtraListenersContainer extends RedpandaContainer {

	private List<Supplier<String>> listeners = new ArrayList<>();

	public RedpandaWithExtraListenersContainer(String image) {
		super(image);
	}
	...
	public RedpandaWithExtraListenersContainer withAdditionalListener(Supplier<String> listener) {
